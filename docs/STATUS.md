...
**อัปเดตล่าสุด:** 2026-09-20 (Playwright walk-in + เปิด/ปิดกะเงินสด)
**เฟสปัจจุบัน:** เฟส 1 MVP ใช้งานได้ในคลินิกตัวอย่าง + เฟส 2 แกนฝากเลี้ยง/กรูมมิ่ง/ภาษีออกบิล
**สถานะ:** Playwright walk-in ผ่าน · เปิด/ปิดกะเงินสดแล้ว · ใบลดหนี้ยังไม่ทำ · ปิด UI-01/02/07 · เปิด UI-03–06, UI-08 · Q5 LINE ยังไม่ทำ · Q6 VAT สินค้ายังรอผู้ทำบัญชี
...
1. [ ] ใบลดหนี้ (ตารางมีแล้ว ยังไม่มี use-case/หน้า)
2. [ ] UI-03 ข้อความรองอ่านยาก / UI-04 label ช่องค้นและสัญญาณชีพ / UI-05 สัดส่วนห้องตรวจ / UI-06 สีแผนก / UI-08 เคาน์เตอร์หลังเลือกสัตว์
...
13. [ ] i18n ระยะ A ตาม [docs/13 §12](13-i18n.md) — วางคลังข้อความ + ตัวสลับภาษา **ควรทำก่อนเริ่มคอนโซลผู้ดูแล** ไม่งั้นต้องกลับมารื้อข้อความ 17 หน้า (รอ Q8)
