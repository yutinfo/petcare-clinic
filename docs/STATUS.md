...
### 2026-09-25 — ป้ายใบกำกับคู่ภาษา, พอร์ทัลสลับภาษา, นำเข้าคำแปล

ตรวจด้วย `npm run typecheck` + `npm run lint` + `npm test` (38) + เทสนำเข้าคำแปลและ RLS และ `npx playwright test e2e/portal-locale.spec.ts e2e/locale.spec.ts e2e/walk-in.spec.ts`

| สิ่งที่ทำ | ไฟล์ | สถานะการตรวจสอบ |
| --- | --- | --- |
| ป้ายบนใบกำกับและใบลดหนี้มีไทยบรรทัดบนและอังกฤษบรรทัดล่าง | `doc-label.tsx`, `pos/receipt.tsx`, `credit-note-print.tsx` | ✅ คลัง `invoice` ใน th/en มีคีย์เท่ากัน ตัวเลขและชื่อคนไม่ถูกแปลเป็นป้าย |
| พอร์ทัลเจ้าของสัตว์สลับภาษาได้ที่หน้าเข้าและหน้าหลัก | `portal/login`, `portal/page.tsx`, `booking-form.tsx` | ✅ Playwright สลับเป็น EN แล้วหัวข้อและปุ่มขอรหัสเป็นอังกฤษ แล้วสลับกลับไทยได้ |
| ตาราง `CatalogTranslation` นำเข้าภาษาเพิ่มได้โดยไม่เพิ่มคอลัมน์ | `catalog-translation.ts`, migration `20260925160000` | ✅ int: นำเข้า en แล้วทับได้ และนำเข้า zh ได้ในแถวใหม่ คนไม่มีสิทธิ์ทำไม่ได้ |

หน้าพนักงานนอก login, หน้าหลัก, เคาน์เตอร์ และเมนู ยังเป็นภาษาไทย ข้อความ error จากเซิร์ฟเวอร์ยังเป็นภาษาไทย
...
| Q9 | ใบกำกับภาษีเต็มรูปใส่ภาษาอังกฤษคู่ได้แค่ไหน ส่วนใดต้องไทยล้วน | ผู้ใช้ | เอกสารพิมพ์สองภาษา (i18n ระยะ C) | ✅ ตอบแล้ว 2026-09-25: ป้ายทุกตัวมีภาษาที่สองคู่กับไทย ค่าที่ไม่ใช่ป้าย (ชื่อคน ชื่อสัตว์ ตัวเลข) ไม่แปลเป็นป้าย จำนวนเงินตัวอักษรไทยยังเป็นบรรทัดหลัก |
| Q10 | ใครสลับภาษาในพอร์ทัลได้ | ผู้ใช้ | พอร์ทัลระยะ D | ✅ ตอบแล้ว 2026-09-25: ผู้ใช้ทุกคนที่เข้าใช้งาน ทั้งพนักงานและเจ้าของสัตว์ |
| Q11 | รองรับภาษาที่สามอย่างไร | ผู้ใช้ | วิธีเก็บคำแปลแค็ตตาล็อก | ✅ ตอบแล้ว 2026-09-25: นำเข้าคลังข้อความและแถวคำแปลได้ ไม่เพิ่มคอลัมน์ต่อภาษา |
...
| 2026-09-25 | ใบกำกับภาษีเต็มรูป: ป้ายทุกตัวมีภาษาที่สองคู่กับไทย | ผู้ใช้ตอบ Q9 | ผู้ใช้ |
| 2026-09-25 | ผู้ใช้ทุกคนที่เข้าใช้งานสลับภาษาเองได้ | ผู้ใช้ตอบ Q10 | ผู้ใช้ |
| 2026-09-25 | ภาษาเพิ่มเข้าระบบด้วยการนำเข้า ไม่เพิ่มคอลัมน์ต่อภาษา | ผู้ใช้ตอบ Q11 | ผู้ใช้ |
