...
6. **ห้ามผลิต AI Slop** — โค้ดเผื่ออนาคต, คอมเมนต์เล่าโค้ด, เทสที่ไม่มีวันแดง,
   รายงานที่อ้างว่าผ่านโดยไม่ได้รัน — ดู AGENTS.md §11 และเดินเช็กลิสต์ §11.5 ก่อนบอกว่าเสร็จ
